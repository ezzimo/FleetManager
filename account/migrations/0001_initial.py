    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_number', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='Driver Registration Number')),
                ('cni', models.CharField(blank=True, max_length=8, null=True, verbose_name='National Identity Code')),
                ('picture', models.ImageField(blank=True, help_text='Driver Identity Picture', null=True, upload_to='images/driver/', verbose_name='Driver Pic')),
                ('birth_date', models.DateField(blank=True, null=True, verbose_name='Date Birth of the Driver')),
                ('birth_city', models.CharField(blank=True, max_length=150, null=True, verbose_name='Birth City of the Driver')),
                ('cnss_registration_number', models.PositiveIntegerField(blank=True, null=True, verbose_name='CNSS Registration Number')),
                ...
                ('rib_bank', models.PositiveIntegerField(blank=True, null=True, verbose_name='RIB of the Driver Bank')),
                ('bank_address', models.CharField(blank=True, max_length=100, null=True)),
                ('driving_licence', models.ImageField(blank=True, help_text='Driver Licence Picture', null=True, upload_to='images/driver_licence/', verbose_name='Driver Licence')),
                ('driver_licence_expiration_date', models.DateField(blank=True, null=True, verbose_name='Expiration Date for Driver Licence')),
                ('glasses', models.BooleanField(default=False, verbose_name='if the Driver use Glasses')),
                ('glasses_certificat', models.ImageField(blank=True, help_text='Driver Glasses Certificat Picture', null=True, upload_to='images/driver_glasse_certificate/', verbose_name='Driver Glasse Certificate')),
            ],
            options={
